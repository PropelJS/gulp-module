...
/**
 * Setups up the cost task
 *
 * @param {Object} gulpRef The gulp instance to attache the task to
 * @param {Object} conf The configuration object
 */
function setupCost (gulpRef, conf) {
  gulp = gulpRef;
  config = conf;

  costPath = path.resolve(config.root, 'docs', 'cost');

  gulp.task('cost', false, [
    'escomplex'
  ], costTask);
}
 ...
 *
 * @return {Array} reports An array of generated reports
 */
